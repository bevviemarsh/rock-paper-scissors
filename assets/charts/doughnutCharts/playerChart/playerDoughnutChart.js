const d3 = require("d3");
const { playerPieChart } = require("./chartComponents/chartContainer");
const {
  graphActions,
...
function renderView(data) {
  ...
  const paths = playerPieChart.selectAll("path").data(data, (d) => d.data.id);
...
function updatedPlayerDoughnut(data) {
  renderView(graphActions.getCalculatedPieData(data, "value"));
  handleTooltips();
}

module.exports.updatedPlayerDoughnut = updatedPlayerDoughnut;
