...
function getLollipopChartDimensions(lollipopChartContainer) {
  const basicWidth = lollipopChartContainer.offsetWidth;
  ...
  const basicHeight = lollipopChartContainer.offsetHeight;
...
const {
  ...
  graphHeight,
  graphPosition,
} = getLollipopChartDimensions(DOMElementsFactory(elements.lollipopChart));

module.exports.lollipopChartDimensions = {
  basicWidth,
  svgWidth,
  graphWidth,
  basicHeight,
